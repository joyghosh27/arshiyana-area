...
<head>
    ...
    <title>Client Login | Ashiyana</title>
...
<body>
    <div class="login-container">
        <div class="welcome-section">
            <h1>Welcome to Ashiyana</h1>
            <p>Your premium property management portal. Access your account to manage your properties and services.</p>
        </div>
